              ...
              {products?.map(pro => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between ">
                    ...
                    <div>
                      <button className="text-[18px] font-display font-bold text-[#629D23] border border-[#629D23] py-[7px] px-3 rounded-[6px] hover:bg-[#629D23] hover:text-white cursor-pointer transition-all ease-in-out duration-300">
                        ADD
                        <span>
